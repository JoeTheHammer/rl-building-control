...
const ControllerToolbar = ({ devMode, onToggleDevMode, onSave, children }: ControllerToolbarProps) => (
  <CustomPage>
    <div className="flex w-full flex-col gap-4 pt-2">
      <div className="grid grid-cols-1 items-center gap-2 md:grid-cols-4">
        <div className="md:col-span-2">
          <span className="text-primary text-md font-bold md:text-xl">Controller Configurator</span>
        </div>
