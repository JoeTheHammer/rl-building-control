...
def test_exact_target_temperature_reward():
    ...
    reward, info = reward_fn({"air_temp_101": 23.0})
...
def test_temperature_above_target():
    ...
    reward, _ = reward_fn({"air_temp_101": 24.0})
...
def test_temperature_below_target():
    ...
    reward, _ = reward_fn({"air_temp_101": 22.0})
...
def test_action_penalty_in_expression():
    ...
    reward, _ = reward_fn({"action": 25.0})
...
def test_combined_temp_and_action_expression():
    ...
    reward, _ = reward_fn({"air_temp_101": 23.0, "action": 25.0})
